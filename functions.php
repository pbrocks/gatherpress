...
if ( ! function_exists( 'gatherpress_setup' ) ) :
	...
	function gatherpress_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'gatherpress_custom_background_args', array(
 ...
 */
function gatherpress_scripts() {
	wp_enqueue_style( 'gatherpress-style', get_stylesheet_uri() );

	wp_enqueue_script( 'gatherpress-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'gatherpress-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'gatherpress_scripts' );
