...
( function( blocks, components, editor, element, i18n ) {
	 ...
	 */
	registerBlockType( 'gatherpress/es5-block', {
		title: __( 'ES5 Block', 'gatherpress' ),
		icon: { 
			background: '#23c3aa',
			foreground: '#fff',
			src: 'megaphone',
