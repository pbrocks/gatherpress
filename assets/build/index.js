...
/***/ "./src/blocks/event-times/index.js":
/*!*****************************************!*\
  !*** ./src/blocks/event-times/index.js ***!
  \*****************************************/
/*! no exports provided */
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__["registerBlockType"])('gatherpress/event-times', {
  ...
  edit: function edit(_ref) {
    ...
    var startDate = attributes.startDate,
        endDate = attributes.endDate; // this.setState({
    // 	treeData: res || []
    // });
...
/* harmony import */ var _images_gatherpress_icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../images/gatherpress-icon */ "./images/gatherpress-icon.js");
/**
 * Internal dependencies
 */
...
wp.blocks.updateCategory('gatherpress', {
  icon: _images_gatherpress_icon__WEBPACK_IMPORTED_MODULE_3__["default"]
});
